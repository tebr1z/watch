...
function watch() {
  let hour = new Date().getHours() * 30; //12 satliq`da her saat 30 derce doner (360/12)
  let minute = new Date().getMinutes() * deg; // deqiqede 6 derece doner
  let second = new Date().getSeconds() * deg; // saniyede 6 derece doner
